...
# Production Quran Data Import - Direct Execution
# This script imports the complete converted data file directly
...
#   ./scripts/import-quran-direct.sh
#
...
# Now execute the full converted file
echo "📖 Importing complete ayahs data..."
echo "⏳ This may take a moment (6,236 ayahs to process)..."

psql -h "$DB_HOST" -p "$DB_PORT" -U "$DB_USER" -d "$DB_NAME" -f scripts/quran-data/converted-hafs-data.sql
